...
render_desktop_file "universal-conversion-hub-uch" "${DEB_ROOT}/usr/share/applications/${PACKAGE_NAME}.desktop"
...
render_desktop_file "${APP_BINARY_NAME}" "${APPDIR_ROOT}/${PACKAGE_NAME}.desktop"
cp -f "${APPDIR_ROOT}/${PACKAGE_NAME}.desktop" "${APPDIR_ROOT}/usr/share/applications/${PACKAGE_NAME}.desktop"
