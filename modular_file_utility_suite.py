...
class SuiteApp:
    ...
    def _run_first_run_setup_wizard(self) -> None:
        ...
        ttk.Label(
            content_body,
            text='Manifest example: {"latest_version":"1.8.7","download_url":"https://example.com/app.exe","notes":"Release notes"}',
            foreground="#57687F",
            wraplength=590,
            justify="left",
    ...
    def _open_settings_dialog(self) -> None:
        ...
        ttk.Label(
            general_tab,
            text='Example JSON: {"latest_version":"1.8.7","download_url":"https://example.com/app.exe","notes":"Release notes"}',
            foreground="#57687F",
            wraplength=760,
        ).pack(anchor="w", pady=(4, 0))
